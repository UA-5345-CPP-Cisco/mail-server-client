                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        Shape {
                            id: _vector_1
                            x: 8.25; y: 8.25
                            height: 1.50; width: 1.50
                            ShapePath {
                                fillColor: "#00000000"
                                strokeColor: "#4a5565"
                                strokeWidth: 1.50
                                PathSvg { path: "M 1.5 0.75 C 1.5 1.1642135828733444 1.1642135828733444 1.5 0.75 1.5 C 0.3357864171266556 1.5 0 1.1642135828733444 0 0.75 C 0 0.3357864171266556 0.3357864171266556 0 0.75 0 C 1.1642135828733444 0 1.5 0.3357864171266556 1.5 0.75 Z" }
                            }
                        }
                        Shape {
                            id: _vector_2
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Shape {
                        id: _vector_4
                        x: 1.50; y: 2.25
                        height: 3.75; width: 15
                        ShapePath {
                            fillColor: "#00000000"
                            strokeColor: "#4a5565"
                            strokeWidth: 1.50
                            PathSvg { path: "M 0.75 0 L 14.25 0 C 14.664213582873344 0 15 0.3357864171266556 15 0.75 L 15 3 C 15 3.4142135828733444 14.664213582873344 3.75 14.25 3.75 L 0.75 3.75 C 0.3357864171266556 3.75 0 3.4142135828733444 0 3 L 0 0.75 C 0 0.3357864171266556 0.3357864171266556 0 0.75 0 Z" }
                        }
                    }
                    Shape {
                        id: _vector_5
                        x: 3; y: 6
                        height: 9.75; width: 12
                        ShapePath {
                            fillColor: "#00000000"
                            strokeColor: "#4a5565"
                            strokeWidth: 1.50
                            PathSvg { path: "M 0 0 L 0 8.25 C 6.661338147750939e-16 8.647824749350548 0.15803519636392593 9.029355324804783 0.4393397569656372 9.310659885406494 C 0.7206443175673485 9.591964446008205 1.1021752506494522 9.75 1.5 9.75 L 10.5 9.75 C 10.897824749350548 9.75 11.279355324804783 9.591964446008205 11.560659885406494 9.310659885406494 C 11.841964446008205 9.029355324804783 12 8.647824749350548 12 8.25 L 12 0" }
                        }
                    }
                    Shape {
                        id: _vector_6
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Shape {
                        id: _vector_7
                        x: 2.25; y: 4.50
                        height: 0; width: 13.50
                        ShapePath {
                            fillColor: "#00000000"
                            strokeColor: "#4a5565"
                            strokeWidth: 1.50
                            PathSvg { path: "M 0 0 L 13.5 0" }
                        }
                    }
                    Shape {
                        id: _vector_8
                        x: 3.75; y: 4.50
                        height: 12; width: 10.50
                        ShapePath {
                            fillColor: "#00000000"
                            strokeColor: "#4a5565"
                            strokeWidth: 1.50
                            PathSvg { path: "M 10.5 0 L 10.5 10.5 C 10.5 11.25 9.75 12 9 12 L 1.5 12 C 0.75 12 0 11.25 0 10.5 L 0 0" }
                        }
                    }
                    Shape {
                        id: _vector_9
                        ...
                        ShapePath {
                            ...
                            strokeColor: "#4a5565"
                            strokeWidth: 1.50
                            PathSvg { path: "M 0 3 L 0 1.5 C 0 0.75 0.75 0 1.5 0 L 4.5 0 C 5.25 0 6 0.75 6 1.5 L 6 3" }
                        }
                    }
                    Shape {
                        id: _vector_10
