...
namespace ISXMail {
    ...
    {
        return language_code == "en" || language_code == "uk" || language_code == "pl";
    }
    ...
    bool LocalizationManager::ApplyLanguage(const QString& language_code, bool persist)
    {
        ...
        const bool has_translation_catalog =
            locale.language() == QLocale::Ukrainian || locale.language() == QLocale::Polish;
