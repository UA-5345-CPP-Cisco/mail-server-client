...
EmailPageProxy::EmailPageProxy(QObject* parent) : QSortFilterProxyModel(parent)
{
}
...
void EmailPageProxy::setSourceModel(QAbstractItemModel* sourceModel)
{
  ...
  if (sourceModel)
  {
    connect(sourceModel, &QAbstractItemModel::rowsInserted, this, &EmailPageProxy::recalcValues);
    connect(sourceModel, &QAbstractItemModel::rowsRemoved, this, &EmailPageProxy::recalcValues);
    connect(sourceModel, &QAbstractItemModel::modelReset, this, &EmailPageProxy::recalcValues);
    connect(sourceModel, &QAbstractItemModel::layoutChanged, this, &EmailPageProxy::recalcValues);
  }
  recalcValues();
}
...
void EmailPageProxy::removeEmailData(int proxyRow)
{
  ...
  while (auto* proxy =
           qobject_cast<QAbstractProxyModel*>(const_cast<QAbstractItemModel*>(idx.model())))
  {
