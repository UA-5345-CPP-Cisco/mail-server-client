...
CacheStore::CacheStore(Database& database) : m_database(database)
{
}
...
std::optional<CacheStore::Entry> CacheStore::Get(const std::string& cache_namespace,
                                                 const std::string& cache_key,
...
std::string
CacheStore::TimePointToString(const std::chrono::system_clock::time_point& time_point) const
{
