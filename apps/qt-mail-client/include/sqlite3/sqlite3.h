...
#endif
#elif
defined(_MSC_VER) || defined(__BORLANDC__) typedef __int64 sqlite_int64;
...
#define
                                                        SQLITE_IOERR_SHMMAP(SQLITE_IOERR |
                                                                            (21 << 8))
#define
                                                          SQLITE_IOERR_SEEK(SQLITE_IOERR |
                                                                            (22 << 8))
#define
                                                            SQLITE_IOERR_DELETE_NOENT(SQLITE_IOERR |
                                                                                      (23 << 8))
#define
...
#define
                                              SQLITE_CONSTRAINT_PINNED(SQLITE_CONSTRAINT |
                                                                       (11 << 8))
#define
                                                SQLITE_CONSTRAINT_DATATYPE(SQLITE_CONSTRAINT |
                                                                           (12 << 8))
#define
                                                  SQLITE_NOTICE_RECOVER_WAL(SQLITE_NOTICE |
                                                                            (1 << 8))
#define
                                                    SQLITE_NOTICE_RECOVER_ROLLBACK(SQLITE_NOTICE |
                                                                                   (2 << 8))
#define
                                                      SQLITE_NOTICE_RBU(SQLITE_NOTICE | (3 << 8))
#define
                                                        SQLITE_WARNING_AUTOINDEX(SQLITE_WARNING |
                                                                                 (1 << 8))
#define
...
#define
    ...
    */
    SQLITE_API int
    sqlite3_trace_v2(
      sqlite3*, unsigned uMask, int (*xCallback)(unsigned, void*, void*, void*), void* pCtx);
...
#define
  ...
  */
  ...
  SQLITE_API int sqlite3_bind_text64(
    sqlite3_stmt*, int, const char*, sqlite3_uint64, void (*)(void*), unsigned char encoding);
...
*/
#ifndef
    SQLITE_OMIT_DEPRECATED SQLITE_API SQLITE_DEPRECATED int
...
#define
  ...
  */
  ...
  SQLITE_API void sqlite3_result_text64(
    sqlite3_context*, const char* z, sqlite3_uint64 n, void (*)(void*), unsigned char encoding);
...
#define
  ...
  */
  struct sqlite3_module
  {
    int iVersion;
    int (*xCreate)(
      sqlite3*, void* pAux, int argc, const char* const* argv, sqlite3_vtab** ppVTab, char**);
    int (*xConnect)(
      sqlite3*, void* pAux, int argc, const char* const* argv, sqlite3_vtab** ppVTab, char**);
    ...
    int (*xFilter)(
      sqlite3_vtab_cursor*, int idxNum, const char* idxStr, int argc, sqlite3_value** argv);
    ...
    ** Those below are for version 4 and greater. */
    int (*xIntegrity)(
      sqlite3_vtab* pVTab, const char* zSchema, const char* zTabName, int mFlags, char** pzErr);
  };
...
*/
#if
  defined(SQLITE_ENABLE_PREUPDATE_HOOK) SQLITE_API void* sqlite3_preupdate_hook(
    sqlite3 * db,
...
#define
    ...
    */
    SQLITE_API int
    sqlite3_carray_bind_v2(sqlite3_stmt * pStmt, /* Statement to be bound */
...
#define
  ...
  */
  SQLITE_API int sqlite3session_diff(
    sqlite3_session * pSession, const char* zFromDb, const char* zTbl, char** pzErrMsg);
...
#define
  ...
  */
  ...
  SQLITE_API int sqlite3changeset_start_strm(
    sqlite3_changeset_iter * *pp, int (*xInput)(void* pIn, void* pData, int* pnData), void* pIn);
  ...
  SQLITE_API int sqlite3changegroup_add_strm(
    sqlite3_changegroup*, int (*xInput)(void* pIn, void* pData, int* pnData), void* pIn);
...
#define
  SQLITE_SESSION_CONFIG_STRMSIZE 1
    ...
    */
    SQLITE_API int
    sqlite3changegroup_config(sqlite3_changegroup*, int, void* pArg);
...
#define
  SQLITE_CHANGEGROUP_CONFIG_PATCHSET 1
    ...
    */
    ...
    sqlite3changegroup_change_begin(
      sqlite3_changegroup*, int eOp, const char* zTab, int bIndirect, char** pzErr);
  ...
  */
  SQLITE_API int sqlite3changegroup_change_int64(
    sqlite3_changegroup*, int bNew, int iCol, sqlite3_int64 iVal);
  ...
  */
  SQLITE_API int sqlite3changegroup_change_finish(sqlite3_changegroup*, int bDiscard, char** pzErr);
