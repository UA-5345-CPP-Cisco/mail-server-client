...
public:
	...
	std::optional<MessageRecipientRecord> FindById(
		std::int64_t recipient_id
	) const;
	std::vector<MessageRecipientRecord> FindByMessageId(
		std::int64_t message_id
	) const;
